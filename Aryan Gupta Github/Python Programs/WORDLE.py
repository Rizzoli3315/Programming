...
def play_wordle():
    ...
    word_list = ["python", "apple", "table", "swift", "world", "month", "fruit", "happy", "light", "smile", "tiger", "lion", "swim", "lemon", "pilot", "smile", "tiger", "lion", "swim", "lemon", "pilot", "dream", "guard", "flood", "adult", "sight", "alarm", "force", "wound", "brave", "cable", "panic", "study", "faith", "equal", "grade", "award", "bully", "voice", "drive", "Flirt", "fifth", "gamer", "mouse"]
